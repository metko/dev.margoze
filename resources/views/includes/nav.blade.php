   ...
   <div class="flex items-center justify-center h-12 px-2">  
    ...
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between py-4">
        <div>
          <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-indigo-800" viewBox="0 0 24 24">
        ...
        <div class="hidden sm:flex sm:items-center">
            @guest
                <a href="{{ route('login') }}" class="text-gray-800 text-sm font-semibold hover:text-indigo-800 mr-4">Sign in</a>
        ...
        <div class="sm:hidden cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-indigo-800" viewBox="0 0 24 24">
      ...
      <div class="block sm:hidden bg-white border-t-2 py-2">
        <div class="flex flex-col">
          <a href="#" class="text-gray-800 text-sm font-semibold hover:text-indigo-800 mb-1">Demandes</a>
          <a href="#" class="text-gray-800 text-sm font-semibold hover:text-indigo-800 mb-1">Offres</a>
          <a href="#" class="text-gray-800 text-sm font-semibold hover:text-indigo-800 mb-1">Plans</a>
          <div class="flex justify-between items-center border-t-2 pt-2">
            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-indigo-800 mr-4">Sign in</a>
            <a href="#" class="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-indigo-800 hover:border-indigo-800">Sign up</a>
          </div>
        </div>
      </div>
    </div>
