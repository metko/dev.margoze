...
<div class="flex p-5 lg:p-8 hover:bg-gray-100 border-b border-gray-100">
   ...
   <div class=" ml-6 flex flex-col justify-around">
      <div class="uppercase font-bold text-gray-700 text-xs  ">
         <a href="#" class='hover:text-blue-primary'>{{$demand->category->name}}</a> - sub categ
      </div>
      <div class="title l4 text-gray-800 mb-2">
         <a href="{{ $demand->path() }}">{{ $demand->title }}</a>
      </div>
      ...
      <div class="uppercase  text-gray-700 text-xs ">
         ...
         <span class="mr-0 border rounded border-gray-600 px-2 py-1">{{$demand->validFor}} jours restants</span>
      </div>
   </div>
</div>