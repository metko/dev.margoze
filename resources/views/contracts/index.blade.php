...
@section('main')
<div class="hero items-center border-b border-gray-100 px-10 py-6 md:py-12">
   <div class="mb-10">
   ...
   <div class="flex flex-wrap -m-4 mt-2">
      <div class="w-full p-4 -mx-5 flex">
         ...
         @empty
            <div class="flex relative flex-col items-center w-full">
                  ...
                  <div class="z-10 flex items-center ml-8 flex-col">
                     <div class="title l4 text-center text-gray-700">Vous n'avez aucuns contrats actuellement</div>  
                  </div>
            </div>
         @endforelse
      </div> 
