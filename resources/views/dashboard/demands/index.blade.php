...
<div class="p-10 border-b border-gray-100">
  @if (! $demands->where('contracted', null)->where('valid_until' ,'>' , now()) )
      <h4 class="title l4 text-blue-primary ">12 demandes en cours</h4>
  @endif
         ...
         <div class="w-full p-4">
            <div class="flex relative flex-col items-center">
                  ...
                  <div class="z-10 flex items-center ml-8 flex-col">
                     <div class="title l4 text-gray-700">Vous n'avez aucune demandes actives actuellement</div> 
                     <div class="mt-3">
